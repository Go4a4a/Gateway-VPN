...
**Следующий шаг:** собрать exact signed/versioned Gateway candidate из clean commit, выполнить production-like Ubuntu 24.04/systemd install и harness smoke, затем запустить несокращаемый 24-часовой developer endurance.
