...
**Общее состояние:** `INITIAL_TOPOLOGY_EXTERNAL_CONFIRMATION_LOCAL_PASS / APPLIED_TOPOLOGY_UPGRADE_PRESERVATION_LOCAL_PASS / FULL_CI_PASS / NEW_IMMUTABLE_CANDIDATE_PENDING / HARDWARE_AND_ENDURANCE_GATES_PENDING`
