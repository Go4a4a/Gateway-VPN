...
**Общее состояние:** `IMMUTABLE_PUBLIC_RELEASE / EXPANDED_SUCCESSOR_IMPLEMENTATION / GATEWAY_REMOTE_SIGNED_SOURCE_LOCAL_PASS / MIHOMO_MAINTENANCE_CHANNEL_LOCAL_BROWSER_PASS / GATEWAY_COMPLETE_RESTORE_POINT_SYSTEMD_REBOOT_PASS / VPS_UPDATE_SYSTEMD_SIGKILL_ROLLBACK_PASS / BOTH_ROLES_SHARED_LIFECYCLE_LOCK_PASS / VPS_UNINSTALL_LIFECYCLE_SYSTEMD_PASS / SCHEMA_V34_EXACT_LIFECYCLE_PASS / AUTOMATIC_UPDATE_SERVICE_ROUTE_LOCAL_PASS / MANAGEMENT_FABRIC_RUNTIME_OBSERVER_PRIVILEGED_PASS / EXACT_UNINSTALL_NEW_PID1_RECOVERY_PASS / MANAGEMENT_FABRIC_GATEWAY_PRIVILEGED_NETNS_PASS / MANAGEMENT_RESOURCES_FIVE_PROFILE_NETNS_PASS / VPS_AGENT_HUB_CONTROL_PLANE_LOCAL_PASS / VPS_AGENT_SCHEMA_V4_EXACT_LIFECYCLE_PASS / VPS_PRIVILEGED_FABRIC_RUNTIME_LOCAL_PASS / VPS_AGENT_HUB_BACKUP_LOCAL_PASS / VPS_OPERATIONS_DIAGNOSTICS_LOCAL_PASS / VPS_OPERATIONS_ROOT_BOUNDARY_PRIVILEGED_PASS / GATEWAY_VPS_AMNEZIA_UFW_DOCKER_COEXISTENCE_NETNS_PASS / ROLE_SEPARATED_BACKUP_LOCAL_PASS / WINDOWS_PORTABLE_DEPLOY_SOURCE_LOCAL_PASS / WINDOWS_EXACT_NATIVE_PE_SMOKE_PASS / WINDOWS_FRESH_TARGET_PREPARATION_LOCAL_PASS / WINDOWS_SANDBOX_CMSERVICE_HVHOST_PASS / CURRENT_COMMIT_FULL_GO_TEST_VET_PASS / CURRENT_SHELL_SYNTAX_GATE_PASS / NONROOT_FULL_RACE_LOCAL_PASS / PREVIOUS_GITHUB_RACE_PASS / SHELL_MODE_LOCAL_PASS / ENDURANCE_CLOCK_FIX_GITHUB_PASS / FULL_CI_RUN_33636614345_PASS / WINDOWS_CLEAN_VM_E2E_PENDING / E2E_ADMIN_RELAY_PRIVILEGED_PACKET_3X_PASS / E2E_RELAY_ROLE_BACKUP_ROUNDTRIP_PASS / WG_ADMIN_ROTATION_ROLLBACK_PASS / LOCAL_RESOURCE_GATEWAY_PACKET_PASS / TOPOLOGY_PROFILE_SAFE_APPLY_PRIVILEGED_PASS / INITIAL_LAN_ROLE_IMPORT_LOCAL_PASS / GROUPED_RESPONSIVE_WEBUI_BROWSER_PASS / FIREWALL_SCHEMA_V7 / WG_INGRESS_LOCAL_PASS / WATCHDOG_SYSTEMD_ZERO_LINK_RECOVERY_PASS / EXACT_SCHEMA34_LIFECYCLE_MATRIX_PASS / MIHOMO_SUCCESSOR_EXACT_BOTH_ROLES_PASS / EXACT_MIHOMO_V1_19_30_MIXED_TUN_SYSTEMD_PASS / EXPLICIT_NEGATIVE_LIFECYCLE_ASSERTIONS_PASS / F9A2CB2_EXACT_BOTH_ROLES_AND_UNINSTALL_PASS / G2203D0B_REPRODUCIBLE_EXACT_BUILD_PASS / G2203D0B_EXACT_BOTH_ROLES_AND_UNINSTALL_PASS / FINAL_LINUX_SOURCE_SECURITY_AUDIT_PASS / HARDWARE_GATES_PENDING`
**Текущий этап:** опубликованный successor `0.1.0-successor.5723940` остаётся неизменяемым контрольным release с проверенной GitHub attestation. Candidate `0.1.0-successor.g2203d0b.crypto5` с Mihomo `v1.19.30` ранее прошёл reproducible build и exact Ubuntu 24.04 lifecycle обеих ролей, но не опубликован. GitHub run `33622765978` подтвердил Windows и весь non-root Linux job; root netns затем нашёл исправленный в `dc0c8d6` Git mode шести новых shell entrypoints. Следующий run `33625094372` снова подтвердил Windows и успешно выполнил все Go packages кроме одного календарно нестабильного smoke fixture: после 2026-09-02 11:15 UTC его hardcoded retention timestamp стал старше собственного предела. Production retention не менялся; fixture привязан к своей фиксированной diagnostic timeline в commit `9028869e0a704b81aa5726c00346005613516ddf` и прошёл 20 повторов. Последний GitHub run `33636614345` для commit `5aad23b1a94762592fa4b82c1767927de31c96f7` успешно завершил Windows portable contract, весь Go race/vet/build/syntax job и все root netns/systemd проверки, включая service-route, Management Resources и VPS ownership. Windows Sandbox закрыта, а disposable Docker targets/evidence/cache после отдельного явного запроса пользователя удалены; полный clean two-target deploy не выполнен и потребует новых чистых targets. Production signing key не открывался; tag и GitHub Release требуют нового отдельного разрешения. Bare-metal/hardware/endurance gates остаются обязательными.
...
| Репозиторий | `F9A2CB2_EXACT_BOTH_ROLES_AND_UNINSTALL_PASS / G2203D0B_REPRODUCIBLE_EXACT_BUILD_PASS / G2203D0B_EXACT_BOTH_ROLES_AND_UNINSTALL_PASS / NONROOT_RACE_FIX_GITHUB_PASS / SHELL_MODE_LOCAL_PASS / ENDURANCE_FIX_GITHUB_PASS / FULL_CI_RUN_33636614345_PASS / PUBLIC_BASE_IMMUTABLE` | Public `v0.1.0-successor.5723940` и Release `378316577` неизменны. Shell mode fix и журнал отправлены до `70fbfdbe90b599890eef9531ae35d7ef07571fd6`; commit `9028869e0a704b81aa5726c00346005613516ddf` исправил calendar-dependent fixture; commit `5aad23b1a94762592fa4b82c1767927de31c96f7` прошёл полный GitHub CI run `33636614345` (Windows, race/vet/build/syntax и root netns/systemd). Production tag/Release не создавались |
