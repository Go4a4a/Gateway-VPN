...
| Репозиторий | `F9A2CB2_EXACT_BOTH_ROLES_AND_UNINSTALL_PASS / G2203D0B_REPRODUCIBLE_EXACT_BUILD_PASS / G2203D0B_EXACT_BOTH_ROLES_AND_UNINSTALL_PASS / NONROOT_RACE_FIX_GITHUB_PASS / SHELL_MODE_FIX_PENDING / PUBLIC_BASE_IMMUTABLE` | Public `v0.1.0-successor.5723940` и Release `378316577` неизменны. Ownership fix и сессия 162 отправлены до `b68675190664726c3b073b69728102dbff575892`; GitHub run `33622765978` подтвердил Windows и non-root Linux jobs. Shell Git mode fix имеет code identity `dc0c8d6326777ab9a89d4125f1ab2d24d8a81fb4`; повторный push/CI pending. Production tag/Release не создавались |
