...
| Репозиторий | `F9A2CB2_EXACT_BOTH_ROLES_AND_UNINSTALL_PASS / G2203D0B_REPRODUCIBLE_EXACT_BUILD_PASS / G2203D0B_EXACT_BOTH_ROLES_AND_UNINSTALL_PASS / NONROOT_RACE_FIX_LOCAL_PASS / PUBLIC_BASE_IMMUTABLE` | Public `v0.1.0-successor.5723940` и Release `378316577` неизменны. 43 накопленных commits и preview fix отправлены в `origin/main` до `be99f1fb87d023445f2f40df04388bb21142dc6d`. Новый ownership-fixture fix имеет code identity `6a91c6dd49769415fe9a2d484be64bbc44462341`; повторный GitHub CI и push этого журнала pending. Production tag/Release не создавались |
