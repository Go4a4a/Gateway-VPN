...
- после `e4cf741` GitHub автоматически заменил устаревший CI #83 новым CI #84; secret-history и Windows jobs CI #84 уже завершились успешно, основной Go/packaging job ещё выполняется.
