...
| 27 | `IN_PROGRESS_LOCAL` | Bounded persistent operations и refresh disabled user method готовы; route ladder, single-flight operation binding и UI panel ещё не реализованы |
