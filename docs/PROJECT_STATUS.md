...
| Packaging | `PRODUCTION_GVKEY_READY / REPRODUCIBLE_5723940_INSTALL_READY` | Две offline сборки `0.1.0-successor.5723940` совпали по bytes/SHA-256/mode/size всех 78 файлов. Gateway `c4ff9417…`, VPS `58c33730…`, bootstrap `aa76dccb…`, deploy `4e91bba7…`, channel `b978f197…`; signer `8231e4d3…`; generic installer не кодирует NIC/CIDR. Fresh apply/PID1 gates прошли; public tags/releases отсутствуют |
...
| Автоматические тесты | `LOCAL_REMOTE_0DD18DD_AND_SIGNED_GATE_PASS` | Full Windows suite/vet, Linux cross-compile, exact remote race/build/netns/systemd run `33130137658` и local exact signed fresh-install/new-PID1/kernel gates проходят |
