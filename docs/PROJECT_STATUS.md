...
| Репозиторий | `MIHOMO_MAINTENANCE_SOURCE_READY / PUBLIC_BASE_IMMUTABLE` | Public `v0.1.0-successor.5723940` и Release `378316577` неизменны. Schema-34 lifecycle baseline остаётся commit `429810f63fae3e03a494bbe55cb1678bdba32fe7`; после локальной фиксации текущего increment ветка `main` будет на 25 commit впереди `origin/main`. Push/tag/Release не выполнялись |
