...
| Packaging | `47297A7_VALIDATION_SUCCESSOR_PASS / PUBLIC_RELEASE_PENDING` | `0.1.0-validation.47297a7` имеет reproducible 76-file distribution, verified 45-file Ed25519 release tree, SBOM/provenance/channel consistency, актуальный H1/H2 runbook, fresh install/idempotency и новый PID 1. Это disposable-signed validation identity, не production release; permanent key, новая public version, LAN interface, push/tag/assets и GitHub installation остаются отдельными рубежами |
