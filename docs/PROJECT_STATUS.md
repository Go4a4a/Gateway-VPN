...
**Следующий шаг:** дождаться CI для commit `693f70e`; testing Draft не публиковать без отдельного разрешения. После зелёного CI остаются clean Windows guest и физические hardware/VPS gates.
