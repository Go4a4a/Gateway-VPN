...
**Следующий шаг:** после проверки этого журнала подготовить commit и push текущего source+journal в `origin/main` (без создания нового tag/Release), затем дождаться CI; testing Draft не публиковать без отдельного разрешения.
