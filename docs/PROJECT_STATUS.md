...
| Репозиторий | `F9A2CB2_EXACT_BOTH_ROLES_AND_UNINSTALL_PASS / G2203D0B_REPRODUCIBLE_EXACT_BUILD_PASS / G2203D0B_EXACT_BOTH_ROLES_AND_UNINSTALL_PASS / NONROOT_RACE_FIX_GITHUB_PASS / SHELL_MODE_LOCAL_PASS / ENDURANCE_FIX_PENDING / PUBLIC_BASE_IMMUTABLE` | Public `v0.1.0-successor.5723940` и Release `378316577` неизменны. Shell mode fix и журнал отправлены до `70fbfdbe90b599890eef9531ae35d7ef07571fd6`; run `33625094372` выявил единственный wall-clock-dependent endurance fixture. Его fix имеет code identity `9028869e0a704b81aa5726c00346005613516ddf`; push/CI pending. Production tag/Release не создавались |
