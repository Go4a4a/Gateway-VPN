...
(function installContextualHelp() {
  const descriptions = {
    ...
    maximum_apply_delay_hours: 'Максимальный срок, в течение которого verified release может ждать окна и готовности. После него автоматические повторы прекращаются, но принудительная установка не выполняется.',
