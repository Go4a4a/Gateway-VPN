...
func TestDiagnosticBundleContainsManifestRequiredSectionsAndNoSecrets(t *testing.T) {
	...
	for _, name := range []string{
		...
		"runtime/watchdog-policy.json", "runtime/watchdog-status.json",
	...
	for _, expected := range []string{"***1234", "Whitelist subscription", "visible", "https://event.example/", "https://journal.example/", `"integrity_check": "PASS"`, `"schema_version": 31`, `"health_days": 7`, `"traffic_months": 24`} {
