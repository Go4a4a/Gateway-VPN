...
func TestDiagnosticBundleContainsManifestRequiredSectionsAndNoSecrets(t *testing.T) {
	...
	for _, expected := range []string{"***1234", "Whitelist subscription", "visible", "https://event.example/", "https://journal.example/", `"integrity_check": "PASS"`, `"schema_version": 28`, `"health_days": 7`, `"traffic_months": 24`} {
